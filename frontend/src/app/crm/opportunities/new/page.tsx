...
export default function NewOpportunityPage() {
  ...
  return (
    <Shell>
      <h1 className="mb-4 text-2xl font-bold text-[#2C1810]">New Opportunity</h1>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4">
            <label className="mb-1 block text-xs font-medium text-[#5C4033]">Notes</label>
            <textarea value={form.notes} onChange={(e) => set('notes', e.target.value)} rows={3} className="w-full rounded-md border border-[#D4C4A8] bg-white px-3 py-2 text-sm text-[#2C1810]" />
          </div>
