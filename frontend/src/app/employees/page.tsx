  ...
  return (
    <Shell>
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-2xl font-bold text-[#5C4033]">Employees</h1>
      ...
      <div className="mb-4 flex flex-wrap items-end gap-3">
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-[#8B7355]">Department</label>
            ...
            <TBody>
              ...
              {!loading && data?.data.map((emp) => (
                <TR key={emp.id}>
                  ...
                  <TD className="text-sm text-[#8B7355]">{emp.email}</TD>
