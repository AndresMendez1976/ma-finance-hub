...
export default function NewInvoicePage() {
  ...
  return (
    <Shell>
      <h1 className="mb-4 text-2xl font-bold text-[#5C4033]">New Invoice</h1>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card className="border-[#E8DCC8]">
          <CardHeader><CardTitle className="text-[#5C4033]">Customer</CardTitle></CardHeader>
          <CardContent className="space-y-3">
            <div>
              <label className="text-sm font-medium text-[#5C4033]">Name *</label>
            ...
            <div>
              <label className="text-sm font-medium text-[#5C4033]">Address</label>
              <textarea
        ...
        <Card className="border-[#E8DCC8]">
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-sm font-medium text-[#5C4033]">Issue Date *</label>
                <Input type="date" value={issueDate} onChange={(e) => setIssueDate(e.target.value)} />
              </div>
              <div>
                <label className="text-sm font-medium text-[#5C4033]">Due Date *</label>
                <Input type="date" value={dueDate} onChange={(e) => setDueDate(e.target.value)} />
              </div>
            </div>
            <div>
              <label className="text-sm font-medium text-[#5C4033]">Tax Rate (%)</label>
      ...
      <Card className="mt-4 border-[#E8DCC8]">
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="text-[#5C4033]">Line Items</CardTitle>
        ...
        <CardContent>
          ...
          <div className="mt-4 border-t border-[#E8DCC8] pt-4 text-right">
            ...
            {taxRate > 0 && (
              <div className="flex justify-end gap-8 text-sm">
                <span className="text-[#8B7355]">Tax ({taxRate}%):</span>
