  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8]">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <h1 className="text-4xl font-extrabold text-[#2C1810]">About Us</h1>
        ...
        <div className="mt-12 flex gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#2C1810]">Our Mission</h2>
        ...
        <div className="mt-10 flex gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#2C1810]">The Company</h2>
            <p className="mt-2 text-[#5C4033]">
        ...
        <div className="mt-10 flex gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#2C1810]">Our Products</h2>
            <ul className="mt-3 space-y-3 text-[#5C4033]">
              <li>
                <span className="font-semibold text-[#2C1810]">MA Finance Hub</span>{' '}
                — Full-featured ERP covering accounting, invoicing, inventory,
                payroll, manufacturing, and CRM.
              </li>
              <li>
                <span className="font-semibold text-[#2C1810]">ChiroBill</span>{' '}
                — Chiropractic practice management and billing platform with
                insurance claims processing.
              </li>
              <li>
                <span className="font-semibold text-[#2C1810]">INIP</span>{' '}
        ...
        <div className="mt-10 rounded-xl border border-[#E8DCC8] bg-white p-6">
          <h2 className="text-xl font-bold text-[#2C1810]">Contact</h2>
          <p className="mt-2 text-[#5C4033]">
            Email:{' '}
          ...
          <p className="mt-1 text-[#5C4033]">Location: Odessa, TX</p>
        </div>
      </section>
