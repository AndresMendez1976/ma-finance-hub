...
export default function NewProjectPage() {
  ...
  return (
    <Shell>
      <h1 className="mb-4 text-2xl font-bold text-[#2C1810]">New Project</h1>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card className="border-[#E8DCC8]">
          ...
          <CardContent className="space-y-3">
            <div><label className="text-sm font-medium text-[#2C1810]">Name *</label>
              <Input value={name} onChange={(e) => setName(e.target.value)} placeholder="Project name" /></div>
            <div><label className="text-sm font-medium text-[#2C1810]">Client (Contact ID)</label>
        ...
        <Card className="border-[#E8DCC8]">
          ...
          <CardContent className="space-y-3">
            <div><label className="text-sm font-medium text-[#2C1810]">Budget Type</label>
            ...
            <div><label className="text-sm font-medium text-[#2C1810]">Budget Amount</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div><label className="text-sm font-medium text-[#2C1810]">Start Date</label>
